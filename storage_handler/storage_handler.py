...
class StorageHandler(ABC):
    ...
    @abstractmethod
    def list_files(self, prefix: Optional[PosixPath | str] = "", relative: bool = True) -> List[str]:
        """
        List files under a given prefix.

        Args:
            prefix (Optional[PosixPath | str]): The prefix to filter files.
    ...
    @abstractmethod
    def list_files_recursive(self, prefix: Optional[PosixPath | str] = "", relative: bool = True) -> List[str]:
        """
    ...
    def glob_files(self, pattern: Optional[PosixPath | str], relative: bool = True) -> List[str]:
        ...
        Args:
            pattern (Optional[PosixPath | str]): The glob pattern to match files.
    ...
    @abstractmethod
    def get_file_metadata(self, remote_path: Optional[PosixPath | str], relative: bool = True) -> Optional[dict]:
        """
